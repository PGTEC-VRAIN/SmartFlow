...
from dags.GEPS_ENS_CNC import ejecutar_descarga_geps
...
MODELO = "ecmwf_seas5_6hourly"#"gfs_global" #"meteofrance_arpege_europe" #"ecmwf_ifs"
...
def ejecutar_descarga_seas5():
    ...
    print("FIN DEL PROCESO DE DESCARGA DE PREDICCIONES SEAS5 de Copernicus.")
    print("\n FIN")

with DAG(
    dag_id='SEAS5_ECMWF_Copernicus',
    default_args=default_args,
    description='Descarga y procesamiento de predicciones SEAS5 de Copernicus para la Comunidad Valenciana',
    schedule='0 */1 * * *',  # Cada 1 hora
    start_date=datetime(2025, 10, 1),
    catchup=False,
    tags=['SEAS5', 'Copernicus', 'meteorología', 'ECMWF'],
) as dag:
    
    # 1. Tarea para ejecutar el procesamiento y descarga
    procesar_seas5_ecmwf = PythonOperator(
        task_id='procesar_seas5_ecmwf',
        python_callable=ejecutar_descarga_seas5, # Llama a la función Python
    )
    procesar_seas5_ecmwf
