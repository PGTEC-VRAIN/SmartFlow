...
router = APIRouter(
    prefix="/GEPS_ENS_CNC",  # Todas las rutas aquí comenzarán con /GEPS_ENS_CNC
    tags=["GEPS_ENS_CNC"] # Agrupa las rutas en Swagger UI
)
...
def find_latest_json_path(directory_path: str, filename_pattern: str) -> str:
    ...
    if not list_of_files:
        ...
        raise HTTPException(status_code=503, detail=f"Datos del modelo GEPS_ENS_CNC no disponibles. No se encontraron archivos.")
...
async def get_GEPS_ENS_CNC_data(
